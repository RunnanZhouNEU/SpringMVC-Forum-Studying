...
<div class="head">Thread : ${threads.subject}</div>
<%-- ${requestScope['javax.servlet.forward.query_string']==null} --%>
<a class="btn btn-outline-dark btn-lg createleft"  role="button" href="${uri}?page=${num}&sort=date" >Sort by Date</a>
<a class="btn btn-outline-dark btn-lg createleft"  role="button" href="${uri}?page=${num}&sort=vote">Sort by Vote</a>
 <a class="btn btn-outline-dark btn-lg createright"  href = "${contextPath}/createpost" role="button">Create a post</a>
 ...
 <div class="container">
	 ...
	 <div class="next-container">
		 <c:if test="${num>1}">
		 	<a  class="btn btn-outline-dark btn-lg prev"  role="button" href="${uri}?page=${num-1}${sortage}" >Prev</a>
		 </c:if>
		 
	 	<c:if test="${num<maxPage}">
	 	<a  class="btn btn-outline-dark btn-lg next"  role="button" href="${uri}?page=${num+1}${sortage}" >Next</a>
	 	</c:if>
	 </div>
